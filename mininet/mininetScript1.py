...
class SimpleTopo(Topo):
    ...
    def build(self):
        ...
        #self.addLink(h1, s2, intfName1='h1-eth-s2', intfName2='s2-eth-h1', port1=1, port2=1)
        self.addLink(h2, s2, intfName1='h2-eth-s2', intfName2='s2-eth-h2', port1=1, port2=2)

        self.addLink(h1, s1, intfName1='h1-eth-s1', intfName2='s1-eth-h1', port1=2, port2=1)
        #self.addLink(h2, s1, intfName1='h2-eth-s1', intfName2='s1-eth-h2', port1=2, port2=2)

        self.addLink(klient1, s3, intfName1='k1-eth-s3', intfName2='s3-eth-k1', port1=1, port2 = 2)
        self.addLink(klient2, s3, intfName1='k2-eth-s3', intfName2='s3-eth-k2', port1=1, port2=4)

        self.addLink(s1, s3, port1=3, port2=3) #s1-eth3<->s3-eth3
        self.addLink(s2, s3, port1=3, port2=1) #s2-eth3<->s3-eth4
